...
# Load your YOLO and behavioral detection models
model_yolo = YOLO("yolov5s.pt")
behavioral_model = load_model("model.h5", compile=False)

# Define your CLASSES_LIST and classNames
...
# Function to process video and perform inference
def process_video(video_file):
    ...
    while True:
        ...
        # Perform face detection using face_recognition here
    ...
    if k == ord('q'):
        break
        # Your behavioral detection logic here
...
# Gradio Interface
iface = Gradio.Interface(fn=process_video, inputs="file", outputs="text")
iface.launch()
